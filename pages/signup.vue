<template>
    <thedynamicisland />
    <a-tooltip class="close" :title="languageStore.currentLanguage.back" @click="closePage">
    ...
    <div class="containersignup">
        ...
        <div class="signinbtn" @click="signIn">{{ languageStore.currentLanguage.haveaccount }}</div>
    </div>
</template>
<script setup>
import { ref } from 'vue';
